...
final class SendRetentionMessages extends Command
{
    protected $signature = 'crm:send-retention-whatsapp
        {--dry-run : Cek jadwal yang jatuh tempo tanpa mengirim WhatsApp}';

    protected $description = 'Kirim satu WhatsApp retention untuk jadwal pembelian yang sudah jatuh tempo.';
